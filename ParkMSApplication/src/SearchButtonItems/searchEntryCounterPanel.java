...
public class searchEntryCounterPanel extends javax.swing.JFrame {
     ...
     */
    public searchEntryCounterPanel(String queryString) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchEntryCounterPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchEntryCounterPanel(queryString).setVisible(true);
            }
        });
    }
