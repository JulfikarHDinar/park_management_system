...
public class searchEntryTicketInfoPanel extends javax.swing.JFrame {
     ...
     */
    public searchEntryTicketInfoPanel(String queryString) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Entry Ticket Information");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchEntryTicketInfoPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchEntryTicketInfoPanel(queryString).setVisible(true);
            }
        });
    }
