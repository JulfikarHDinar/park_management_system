...
public class searchRideInfoPanel extends javax.swing.JFrame {
     ...
     */
    public searchRideInfoPanel(String queryString) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchRideInfoPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchRideInfoPanel(queryString).setVisible(true);
            }
        });
    }
