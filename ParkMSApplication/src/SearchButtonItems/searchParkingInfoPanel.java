...
public class searchParkingInfoPanel extends javax.swing.JFrame {
     ...
     */
    public searchParkingInfoPanel(String queryString) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchParkingInfoPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchParkingInfoPanel(queryString).setVisible(true);
            }
        });
    }
