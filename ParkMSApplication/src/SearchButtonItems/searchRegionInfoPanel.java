...
public class searchRegionInfoPanel extends javax.swing.JFrame {
     ...
     */
    public searchRegionInfoPanel(String queryString) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchRegionInfoPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchRegionInfoPanel(queryString).setVisible(true);
            }
        });
    }
